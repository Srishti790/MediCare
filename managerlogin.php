...
body{
	...
	<div id="page" style="overflow-y:hidden; height:120px;boreder-bottom:2px solid #000">
				...
				<div class="row">
					...
					<div class="col-xs-11 text-right menu-1">
						<ul>
							...
							<li><a href="includes/logout.inc.php" style ="color:#000">Logout</a></li>
						</ul>
					</div>
				</div>
...
<div class='box animated zoomIn'>
  <div class='box-form'>
    ...
    <div class='box-login'>
        <form action ="includes\manageractlogin.inc.php" method ="post">
      <div class='fieldset-body' id='login_form'>
        	<p class='field'>
          <label for='user'>Username</label>
          <input type='text' id='user' name='username' title='Username' />
        ...
        <input type='submit' id='do_login' value='Login' title='Get Started'name ="submit" />
      </div>
    </div>
  </div>
