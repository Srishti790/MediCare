...
<div class ="sidebar_wrapper animated fadeInLeftBig hide">
        ...
        <div class ="drawer-links">
            <div class ="drawer-ul">
                <div class ="drawer-li"><a href ="customerhome.php">Home</a></div>
                <div class ="drawer-li"><a href ="booktechnicians.php">Book Technicians</a></div>
                <div class ="drawer-li"><a href ="viewbill.php">View Bill</a></div>
