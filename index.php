			...
			<div class="container">
				<div class="row">
					...
					<div class="col-xs-11 text-right menu-1">
						<ul>
							<li class ="nav-li"><a href="index.php"style="color:#000">Home</a></li>
							<li class ="nav-li"><a href="about.php"style="color:#000">AboutUs</a></li>
							<li class ="nav-li"><a href="managerlogin.php"style="color:#000">Manager</a></li>
							<li class ="nav-li"><a href="technicianlogin.php"style="color:#000">Technician</a></li>
							<li class ="nav-li"><a href="customerlogin.php"style="color:#000">Customer</a></li>
							<li class ="nav-li"><a href="#contact"style="color:#000">Contact Us</a></li>
						</ul>
					</div>
				</div>
			</div>
